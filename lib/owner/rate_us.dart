...
class _CustomerFeedbackScreenState extends State<RateUs> {
  ...
  bodyWidget(BuildContext context) {
    return Padding(
      padding: const EdgeInsets.only(top: 100, bottom: 100, left: Dimensions.marginSize, right: Dimensions.marginSize),
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            Text(
              Strings.giveReview,
              style: TextStyle(fontSize: Dimensions.extraLargeTextSize, fontWeight: FontWeight.bold, color: Colors.black),
            ),
            SizedBox(
    ...
    return Positioned(
      ...
      child: Padding(
        ...
        child: GestureDetector(
          child: Container(
            height: 65,
            decoration: BoxDecoration(color: CustomColor.primaryColor, borderRadius: BorderRadius.circular(Dimensions.radius * 2)),
            child: Center(
              child: Text(
          ...
          onTap: () {
            Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => OwnerScreen()));
          },
        ),
      ),
    );
